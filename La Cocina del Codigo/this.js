...
!Preguntar QUIEN ES THIS O QUE VALOR TIENE THIS, es lo mismo que preguntar: 
?1)QUE OBJ ESTÁ EJECUTANDO LA FUNCION ESTA VEZ.
?2)EN QUE CONTEXTO SE ESTA EJECUTANDO LA F. 

!REGLA PARA IDENTIFICAR THIS
*1 Si es una FUNCION: pregunto QUIEN? Quien esta ejecutando la funcion? 
*2 Si es ARROW FUNC: pregunto DONDE? Donde esta definida la arrow? Quien es this alli?

? QUE ES EL CONTEXTO? 
*ES EL OBJETO QUE ESTA EJECUTANDO una F en un momento especifico 
...
*BINDING/ENLAZAMIENTO(Unir-Vincular):
...
*this = OBJETO GLOBAL (window o nodeJs)
...
*1)El primer parametro que recibe call es el nuevo contexto(pepe), el objeto que va a ser this.
*2)Luego, los param que va a recibir la F, separados por coma(true, true)
!En conclusion, el METODO SE LLAMA SOBRE EL OBJETO QUE LE PASAMOS
...
*Para instanciar obj podemos usar: 
*1) la funcion constructura  
*2) las clases con constructores.
...
*1- this va a ser el objeto sacha(el valor que queremos). GRACIAS A Q LAS ARROW F SE EJECUTAN EN EL MISMO CONTEXTO EN EL Q FUERON CREADAS
...
*No podemos cambiarle el contexto con call/apply/bind
